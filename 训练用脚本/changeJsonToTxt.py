...
# 处理指定文件夹内的所有JSON文件
json_folder = 'D:/learn/trywork/python/HOK/train1'  # 替换为包含JSON文件的文件夹路径
image_folder = 'D:/learn/trywork/python/HOK/train1'  # 替换为与JSON文件对应的图像文件夹路径
output_folder = 'D:/learn/trywork/python/HOK/train1'  # 替换为要保存TXT文件的文件夹路径
