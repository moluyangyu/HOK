...
def convert_labelme_to_yolov5(json_path):
...
for json_file in json_files:
    ...
    image_path = os.path.join(image_folder, image_file) # 使用适当的方式获取图像的宽度和高度

    annotations = convert_labelme_to_yolov5(json_path)
